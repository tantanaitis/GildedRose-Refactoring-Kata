...
class GildedRoseTest {
    ...
    @Test
    void regularItemSellInZeroQualityMinus1QualityDoesNotChangeTest() {
        Item[] items = new Item[] { new Item("regular", 0, -1) };
        GildedRose app = new GildedRose(items);
        app.updateQuality();
        assertEquals("regular", app.items[0].name);
    ...
    @Test
    void sulfurSellInNotZeroSellInAndQualityDoesNotChangeTest() {
    ...
    @Test
    void sulfurSellInZeroSellInAndQualityMaximumDoesNotChangeTest() {
    ...
    @Test
    void sulfurSellInMinusAndQualityMaximumMinusDoesNotChangeTest() {
